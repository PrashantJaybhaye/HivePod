...
export default function GlobalNotFound() {
  return (
    <div className="min-h-[calc(100vh-120px)] w-full bg-[#fbfbfd] dark:bg-black text-[#1d1d1f] dark:text-[#f5f5f7] flex flex-col items-center justify-center font-sans px-6 selection:bg-[#06c] selection:text-white -mt-6">
      <div className="max-w-2xl w-full text-center flex flex-col items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="w-[1px] h-3 bg-[#d2d2d7] dark:bg-[#424245]" />
